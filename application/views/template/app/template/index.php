...
<html lang="en">
  <head>
    ...
    <!-- vendor css -->
    <link href="<?= base_url() ?>template/plugins/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="<?= base_url() ?>template/plugins/Ionicons/css/ionicons.css" rel="stylesheet">
    <link href="<?= base_url() ?>template/plugins/chartist/css/chartist.css" rel="stylesheet">
    <link href="<?= base_url() ?>template/plugins/rickshaw/css/rickshaw.min.css" rel="stylesheet">

    <!-- Slim CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>template/css/slim.css">
  ...
  <body>
    ...
    <script src="<?= base_url() ?>template/plugins/jquery/js/jquery.js"></script>
    <script src="<?= base_url() ?>template/plugins/popper.js/js/popper.js"></script>
    <script src="<?= base_url() ?>template/plugins/bootstrap/js/bootstrap.js"></script>
    <script src="<?= base_url() ?>template/plugins/jquery.cookie/js/jquery.cookie.js"></script>
    <script src="<?= base_url() ?>template/plugins/chartist/js/chartist.js"></script>
    <script src="<?= base_url() ?>template/plugins/d3/js/d3.js"></script>
    <script src="<?= base_url() ?>template/plugins/rickshaw/js/rickshaw.min.js"></script>
    <script src="<?= base_url() ?>template/plugins/jquery.sparkline.bower/js/jquery.sparkline.min.js"></script>

    <script src="<?= base_url() ?>template/js/ResizeSensor.js"></script>
    <script src="<?= base_url() ?>template/js/dashboard.js"></script>
    <script src="<?= base_url() ?>template/js/slim.js"></script>
  </body>
</html>
